...
export default function AccountSetting() {
  const userID = getUserIdFromToken(); // ดึง user_id จาก token
  ...
  const [formData, setFormData] = useState({
    ...
    lastName: "",
    Username: "",
    email: "", // แสดง email ที่ใช้ log in
    currentPassword: "",
    newPassword: "",
    confirmPassword: "",
  });
  const [message, setMessage] = useState(""); // แสดงข้อความสำเร็จหรือข้อผิดพลาด
      ...
      try {
        ...
        if (res.ok) {
          ...
          setFormData((prevState) => ({
            ...
            email: data.email, // อัปเดต email ที่ใช้ log in
          }));
        } else {
